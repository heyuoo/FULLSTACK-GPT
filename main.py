...
@app.get(
    ...
    description=(
        "Upon receiving a GET request this endpoint will return a real quiote"
        " said by Nicolacus Maximus himself."
    ),
    response_description=(
        "A Quote object that contains the quote said by Nicolacus Maximus and"
